...
func (d *Y16D21) GetInput(year, day int) string {
	return readContent(formatFilename(year, day))
}

func (d *Y16D21) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %s (%v)", year, day, y16d21(y16d21Initial, d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y16D21) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %s (%v)", year, day, y16d21(y16d21Initial, d.GetInput(year, day), 2), time.Since(start))
}

type Y16D22 struct{}

func (d *Y16D22) GetInput(year, day int) string {
	return readContent(formatFilename(year, day))
}

func (d *Y16D22) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y16d22(d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y16D22) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y16d22(d.GetInput(year, day), 2), time.Since(start))
}

type Y16D23 struct{}

func (d *Y16D23) GetInput(year, day int) string {
	return readContent(formatFilename(year, day))
}
...
func (d *Y16D24) GetInput(year, day int) string {
	return readContent(formatFilename(year, day))
}

func (d *Y16D24) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y16d24(d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y16D24) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y16d24(d.GetInput(year, day), 2), time.Since(start))
}

type Y16D25 struct{}

func (d *Y16D25) GetInput(year, day int) string {
	return readContent(formatFilename(year, day))
}

func (d *Y16D25) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y16d25(d.GetInput(year, day)), time.Since(start))
}

func (d *Y16D25) Part2(year, day int) string {
