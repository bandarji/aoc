...
func (d *Y17D02) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d02(d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y17D02) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y17d02(d.GetInput(year, day), 2), time.Since(start))
}
...
func (d *Y17D08) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d08(d.GetInput(year, day), 1), time.Since(start))
}
...
func (d *Y17D13) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d13(d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y17D13) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y17d13(d.GetInput(year, day), 2), time.Since(start))
}

type Y17D14 struct{}

func (d *Y17D14) GetInput(year, day int) string {
	return y17d14KeyString
}
...
func (d *Y17D16) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %s (%v)", year, day, y17d16(d.GetInput(year, day), 16, 1), time.Since(start))
}

func (d *Y17D16) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %s (%v)", year, day, y17d16(d.GetInput(year, day), 16, 2), time.Since(start))
}

type Y17D17 struct{}

func (d *Y17D17) GetInput(year, day int) string {
	return y17d17StartValue
}

func (d *Y17D17) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d17(d.GetInput(year, day), 2017, 2017), time.Since(start))
}

func (d *Y17D17) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y17d17(d.GetInput(year, day), 50_000_000, 0), time.Since(start))
}
...
func (d *Y17D18) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d18(d.GetInput(year, day), 1), time.Since(start))
}
...
func (d *Y17D20) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d20(d.GetInput(year, day), 1), time.Since(start))
}
...
func (d *Y17D23) Part1(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 1: %d (%v)", year, day, y17d23(d.GetInput(year, day), 1), time.Since(start))
}

func (d *Y17D23) Part2(year, day int) string {
	start := time.Now()
	return fmt.Sprintf("Year=%d Day=%02d Part 2: %d (%v)", year, day, y17d23(d.GetInput(year, day), 2), time.Since(start))
}
