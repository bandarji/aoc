...
const y16d22TestInput string = `root@ebhq-gridcenter# df -h
...
func Test_y16d22(t *testing.T) {
	...
	tests := []struct {
		...
		{"test part 1", args{input: y16d22TestInput, part: 1}, 987},
		{"test part 2", args{input: y16d22TestInput, part: 2}, 220},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := y16d22(tt.args.input, tt.args.part); got != tt.want {
				t.Errorf("y16d22() = %v, want %v", got, tt.want)
			}
		})
	}
}
