...
func main() {
	...
	log.Printf("Day 14, part  2 (test 2): %d", d14.Solve(d14.TEST1, 2))
	// log.Printf("Day 14, part  1: %d", d14.Solve(common.ReadContent(14), 1))
	// log.Printf("Day 14, part  2: %d", d14.Solve(common.ReadContent(14), 2))
